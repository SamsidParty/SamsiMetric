 ...
 * (c) 2024 ChartJS.js Contributors
 * Released under the MIT License
 */
!function (t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).ChartJS = e() }(this, (function () {
 ...
 * @param chart - ChartJS.js instance
...
function ChartJSComponent(props, ref) {
    const { height = 150, width = 300, redraw = false, datasetIdKey, type, data, options, plugins = [], fallbackContent, updateMode, ...canvasProps } = props;
    const canvasRef = React.useRef(null);
    const chartRef = React.useRef();
    const renderChartJS = () => {
        if (!canvasRef.current) return;
        chartRef.current = new chart_js.ChartJS(canvasRef.current, {
            type,
...
const ReactChartJS = /*#__PURE__*/ React.forwardRef(ChartJSComponent);

function createTypedChartJS(type, registerables) {
    chart_js.ChartJS.register(registerables);
    return /*#__PURE__*/ React.forwardRef((props, ref) =>/*#__PURE__*/ React.createElement(ReactChartJS, Object.assign({}, props, {
        ref: ref,
        type: type
    })));
}
const Line = /* #__PURE__ */ createTypedChartJS("line", chart_js.LineController);
const Bar = /* #__PURE__ */ createTypedChartJS("bar", chart_js.BarController);
const Radar = /* #__PURE__ */ createTypedChartJS("radar", chart_js.RadarController);
const Doughnut = /* #__PURE__ */ createTypedChartJS("doughnut", chart_js.DoughnutController);
const PolarArea = /* #__PURE__ */ createTypedChartJS("polarArea", chart_js.PolarAreaController);
const Bubble = /* #__PURE__ */ createTypedChartJS("bubble", chart_js.BubbleController);
const Pie = /* #__PURE__ */ createTypedChartJS("pie", chart_js.PieController);
const Scatter = /* #__PURE__ */ createTypedChartJS("scatter", chart_js.ScatterController);

window.ChartJSBar = Bar;
window.ChartJSBubble = Bubble;
window.ChartJSChartJS = ChartJS;
window.ChartJSDoughnut = Doughnut;
window.ChartJSLine = Line;
window.ChartJSPie = Pie;
window.ChartJSPolarArea = PolarArea;
window.ChartJSRadar = Radar;
window.ChartJSScatter = Scatter;
window.ChartJSgetDatasetAtEvent = getDatasetAtEvent;
window.ChartJSgetElementAtEvent = getElementAtEvent;
window.ChartJSgetElementsAtEvent = getElementsAtEvent;

window.ChartJSDashedLine = {
    id: 'dashedline',
    defaults: {
        width: 1,
        color: '#FF4949',
...
chart_js.register(window.ChartJSDashedLine);
...
chart_js.register(ChartDataLabels);